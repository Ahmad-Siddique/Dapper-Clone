    ...
    <section className="relative bg-white py-32 overflow-hidden">
      ...
      <div className="mx-auto max-w-[1500px] px-4 md:px-8">
        ...
        <div className="mb-10 flex items-center justify-center gap-3">
          ...
          <span className="font-[Helvetica_Now_Text,Helvetica,Arial,sans-serif] text-[16px] font-semibold tracking-tight text-[#111111]">
            Compare
          </span>
        </div>

        {/* Heading - tighter tracking */}
        <h2 className="mx-auto mb-10 max-w-5xl text-center font-[Helvetica_Now_Text,Helvetica,Arial,sans-serif] text-[48px] sm:text-[58px] md:text-[68px] lg:text-[78px] xl:text-[88px] font-bold leading-[1.08] tracking-[-0.02em] text-[#111111]">
          <span className="italic font-normal">Traditional B2B marketing</span>{' '}
          <span className="font-bold">vs modern B2B marketing</span>
        </h2>

        {/* Subheading - tighter tracking */}
        <p className="mx-auto mb-24 max-w-3xl text-center font-[Helvetica_Now_Text,Helvetica,Arial,sans-serif] text-[20px] sm:text-[22px] md:text-[24px] font-semibold leading-relaxed tracking-tight text-[#444444]">
        ...
        <div className="grid gap-10 md:grid-cols-2 md:gap-14 lg:gap-20">
          {/* Traditional Column */}
          <div>
            <h3 className="mb-12 text-center font-[Helvetica_Now_Text,Helvetica,Arial,sans-serif] text-[32px] sm:text-[36px] md:text-[40px] font-bold tracking-tight text-[#111111]">
            ...
            <div className="space-y-6">
              {TRADITIONAL_ITEMS.map((item, index) => (
                <div
                  key={index}
                  className="flex items-center gap-6 rounded-2xl border border-black/[0.08] bg-[#F9F9F9] px-8 py-7 transition-all hover:border-black/[0.12] hover:bg-[#F5F5F5]"
                >
                  <div className="flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-lg bg-[#111111]">
                    <svg
                      width="22"
                      height="3"
                      viewBox="0 0 22 3"
                  ...
                  <p className="flex-1 font-[Helvetica_Now_Text,Helvetica,Arial,sans-serif] text-[19px] sm:text-[20px] md:text-[21px] font-bold leading-snug tracking-tight text-[#111111]">
                    {item}
                  </p>
                </div>
              ))}
          ...
          <div>
            ...
            <div className="space-y-6">
              {MODERN_ITEMS.map((item, index) => (
                <div
                  key={index}
                  className="flex items-center gap-6 rounded-2xl border border-[#74F5A1]/30 bg-[#74F5A1]/[0.08] px-8 py-7 transition-all hover:border-[#74F5A1]/50 hover:bg-[#74F5A1]/[0.12]"
                >
                  <div className="flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-lg bg-[#74F5A1]">
                    <svg
                      width="22"
                      height="22"
                      viewBox="0 0 22 22"
