                ...
                {SERVICES_ROW_1.map((service) => {
                  ...
                  return (
                    ...
                    >
                      <div>
                        <h3
                          className="font-[Helvetica Now Text,Arial,sans-serif] text-[18px] font-semibold tracking-tight mb-3"
                          style={{ color: cardText }}
                        >
                          {service.title}
                        </h3>
                        <p
                          className="font-[Helvetica Now Text,Arial,sans-serif] text-[14px] font-regular leading-snug"
                      ...
                      <div className="flex justify-end mt-4">
                        <span className="inline-flex h-8 w-8 flex-shrink-0 items-center justify-center">
                          <span className="relative flex h-8 w-8 items-center justify-center overflow-hidden rounded-[4px] bg-[#74F5A1] transition-all duration-500 ease-out group-hover:bg-black group-hover:scale-110 group-hover:-translate-y-[1px]">
                            <span className="absolute inset-0 flex items-center justify-center transition-all duration-500 ease-out group-hover:translate-x-2 group-hover:-translate-y-2 group-hover:opacity-0">
                              <svg
                                width="14"
                                height="14"
