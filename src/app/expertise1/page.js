...
export default function Expertise1Page() {
  ...
  return (
    <div style={{ position: 'relative', zIndex: 1 }} data-theme={theme} className={theme === 'dark' ? 'bg-[#0a0a0a]' : 'bg-white'}>
      ...
      <Header theme={theme} />
      <HeroExpertise theme={theme} />
      <ClientExpertise theme={theme} />
      <B2BBuyersExpertise theme={theme} />
      <ExpertiseExpertise theme={theme} />
      <BuildDemandExpertise theme={theme} />
      <ProcessExpertise theme={theme} />
      <CRMExpertise theme={theme} />
      <CaseExpertise theme={theme} />
      <FAQExpertise theme={theme} />
